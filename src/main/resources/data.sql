...
INSERT INTO post (title, description, tags, user_id, status, thumbnail_extension, project_date, client, subcontract) VALUES ('Desk Construction', 'The Jhonson Family wanted a desk for their house an we did our best to give then the perfect desk for it. ', 'Construction;Desk', 1, 'A', 'image/jpeg', '2021-06-01 00:00:00', 'Jhonson Family', false);
INSERT INTO post (title, description, tags, user_id, status, thumbnail_extension, project_date, client, subcontract) VALUES ('Front Yard Entrance', 'This front courtyard was made for the Storm Family who wanted to elevate their front entrance to a new level of style and we give then what they was looking for.', 'Construction;Remodeling;Courtyard', 1, 'A', 'image/jpeg', '2021-06-02 00:00:00', 'Storm Family', false);
INSERT INTO post (title, description, tags, user_id, status, thumbnail_extension, project_date, client, subcontract) VALUES ('Balcony', 'The Crinsom''s wanted a balconie for their second floor and we deliver some of our best work.', 'Remodeling;2floor;Balcony', 1, 'A', 'image/jpeg', '2021-06-02 00:00:00', 'Crinsom Family', false);
